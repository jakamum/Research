...
canvas = tk.Canvas(root, width=800, height=1600)
...
text2 = "For God, who commanded the light to shine out of darkness, hath shined in our hearts, to give the light of the knowledge of the glory of God in the face of Jesus Christ."
x, y = 400, 300
radius = 0
start_angle = 0
font_size = 30
...
while True:
    ...
    time.sleep(0.01)
    radius = spiral_text3(canvas, text2, x, y, radius, start_angle, font_size, font_type)
    start_angle += 0.3
